...
urlpatterns = [
    ...
    path("<int:id>/edit/extemporeMotion", edit_extempore_motion_view, name="edit-extemporeMotion"),
    path("<int:id>/edit/announcement", edit_announcement_view, name="edit-announcement"),
    ...
    path("<int:id>/create/extemporeMotion", extemporeMotion_create_view, name="extemporeMotion-create"),
    path("<int:id>/create/announcement", announcement_create_view, name="announcement-create"),
    path("<int:id>/create/discussion", discussion_create_view, name="discussion-create"),
